...
namespace DidactischeLeermiddelen.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ITargetAudienceRepository>().To<TargetAudienceRepository>().InRequestScope();
            kernel.Bind<IUserRepository>().To<UserRepository>().InRequestScope();
            kernel.Bind<IReservedMaterialRepository>().To<ReservedMaterialRepository>().InRequestScope();
            kernel.Bind<TeachingAidsContext>().ToSelf().InRequestScope();
        }        
    }
}
